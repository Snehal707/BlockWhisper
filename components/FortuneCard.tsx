...
export function FortuneCard({ displayFortune, onMint }: FortuneCardProps) {
    return (
        <motion.div
            ...
            className="glass-panel p-5 max-w-md w-full text-center relative z-10 border-2 border-purple-500/30"
        >
            ...
            <div className="prose prose-invert">
                <p className="text-base leading-relaxed italic text-gray-800 dark:text-gray-200 break-words">
                    "{displayFortune}"
                </p>
            </div>
