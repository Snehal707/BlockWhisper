...
interface FarcasterClientProps {
    initialFortune?: string | null;
}

export default function FarcasterClient({ initialFortune }: FarcasterClientProps) {
    ...
    // Mini App Mode is always active here
    const isMiniApp = true;

    // Mini App specific styles
    const shellClass = "relative h-[100dvh] w-full overflow-hidden flex flex-col items-center p-4";
    const bodyWrapClass = "relative z-10 w-full max-w-md mx-auto flex-1 overflow-y-auto overflow-x-hidden px-4 pt-4 pb-6";
    const headerWrapClass = "z-20 w-full max-w-md mx-auto pt-2 pb-2 px-4";
    const footerClass = "py-4 text-center text-gray-500 text-sm";
                ...
                <div className="flex items-center justify-between gap-2 pointer-events-auto w-full">
                    <div className="min-w-0 flex-1">
                        <motion.div
                            ...
                            className="text-base font-bold whitespace-nowrap leading-none"
                        >
                            <span style={{
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                        {isConnected && (
                            ...
                            >
                                ...
                                >
                                    <circle cx="12" cy="11" r="7" stroke="url(#statsGradient)" strokeWidth="1.5" fill="none" className="group-hover:fill-purple-500/10 transition-all" />
                                    <circle cx="12" cy="11" r="4" stroke="url(#statsGradient)" strokeWidth="1" fill="none" opacity="0.5" className="group-hover:opacity-100 transition-opacity" />
                                    ...
                                    <path d="M7 18 Q12 19 17 18" stroke="url(#statsGradient)" strokeWidth="1.5" strokeLinecap="round" fill="none" />
                                ...
                                >
                                    <div className="relative">
                                        <motion.div
                                            ...
                                            className="text-6xl mb-2 filter drop-shadow-[0_0_30px_rgba(168,85,247,0.4)]"
                                        >
                                            🔮
                                        </motion.div>
