...
export default function WebClient({ initialFortune }: WebClientProps) {
    ...
    // Web Mode is always active here
    const isMiniApp = false;

    // Desktop/Web specific styles
    const shellClass = "relative min-h-screen w-full overflow-x-hidden flex flex-col";
    const bodyWrapClass = "relative z-10 w-full max-w-6xl mx-auto px-12 pt-16 pb-16";
    const headerWrapClass = "z-20 w-full max-w-6xl mx-auto flex items-center justify-between gap-6 pt-6 pb-4 px-12";
    const footerClass = "py-6 text-center text-gray-500 text-base";
                ...
                <div className="flex items-center justify-between gap-2 pointer-events-auto w-full">
                    <div className="min-w-0 flex-1">
                        <motion.div
                            ...
                            className="text-2xl md:text-3xl font-bold whitespace-nowrap leading-none"
                        >
                            <span style={{
                        ...
                        <div className="flex flex-col items-center gap-8 text-center">
                            {!isConnected && (
                                ...
                                >
                                    ...
                                    <h1 className="text-6xl md:text-8xl mb-8 font-bold tracking-tighter">
