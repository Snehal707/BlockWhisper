...
const abiPath = join(__dirname, '../artifacts-temp/contracts_BlockWhisperFortune_sol_BlockWhisperFortune.abi');
const binPath = join(__dirname, '../artifacts-temp/contracts_BlockWhisperFortune_sol_BlockWhisperFortune.bin');

const abi = JSON.parse(readFileSync(abiPath, 'utf8'));
const bytecode = '0x' + readFileSync(binPath, 'utf8');
